# scripts/init_cloudsql_demo.py
"""
Initialize Cloud SQL with the same demo data from init_db.py
Simple script to insert the 3 sample hypotheses into PostgreSQL
"""
import sys
import os
...
def init_demo_data():
    ...
    print("🐘 Initializing Cloud SQL with TradeSage demo data...")
    
    # Ensure we're using Cloud SQL
    ...
    try:
        ...
        if existing_hyp:
            ...
            choice = input("Choose action: (o)verwrite, (s)kip: ").lower()
        ...
        print("📊 Creating demo hypotheses...")
        
        # Sample Hypothesis 1: Oil Price Prediction (from original init_db.py)
        hypothesis1_data = {
        ...
        # Add contradictions for hypothesis 1 (same as original)
        contradiction1 = {
        ...
        # Add more contradictions to reach 14 total (simplified)
        for i in range(3, 15):
            contradiction = {
                "hypothesis_id": hyp1.id,
        ...
        # Add research data (same as original)
        research_data1 = {
            "hypothesis_id": hyp1.id,
        ...
        # Add price history for hypothesis 1 (same pattern as original)
        base_price = 82.0
        for i in range(7):
            price_entry = {
                "hypothesis_id": hyp1.id,
        ...
        # Sample Hypothesis 2: US Inflation (from original init_db.py)
        hypothesis2_data = {
        ...
        # Add contradictions and confirmations for hypothesis 2 (simplified)
        # 10 contradictions
        for i in range(10):
            contradiction = {
        ...
        # Sample Hypothesis 3: TTF (Natural Gas) (from original init_db.py)
        hypothesis3_data = {
        ...
        print("\n" + "="*50)
        print("🎉 Demo data initialized successfully in Cloud SQL!")
...
def verify_data():
    ...
    try:
        ...
        print(f"   Found {len(summaries)} hypotheses in database")
...
def main():
    """Main function to handle initialization options."""
